...
class YOLOXHead(nn.Module):
        ...
        for batch_idx in range(outputs.shape[0]):
            ...
            if num_gt == 0:
                ...
                try:
                    ...
                    if "MLU out of memory. " not in str(e):
                        raise  # RuntimeError might not caused by MLU OOM
    ...
    def get_assignments(
        ...
        if mode == "cpu":
            gt_matched_classes = gt_matched_classes.mlu()
            fg_mask = fg_mask.mlu()
            pred_ious_this_matching = pred_ious_this_matching.mlu()
            matched_gt_inds = matched_gt_inds.mlu()
    ...
    def get_geometry_constraint(
        ...
        the number of candidate anchors so that the MLU memory is saved.
        """
