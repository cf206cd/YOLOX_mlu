...
class JitOp:
    ...
    def nvcc_args(self) -> List:
        """Get optional list of compiler flags to forward to nvcc when building MLU sources"""
        args = [
            "-O3", "--use_fast_math",
            "-std=c++17" if sys.platform == "win32" else "-std=c++14",
            "-U__MLU_NO_HALF_OPERATORS__",
            "-U__MLU_NO_HALF_CONVERSIONS__",
            "-U__MLU_NO_HALF2_OPERATORS__",
        ]
        return args
    ...
    def jit_load(self, verbose=True):
        ...
        op_module = load(
            ...
            extra_mlu_cflags=self.nvcc_args(),
            verbose=verbose,
        )
